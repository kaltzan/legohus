...
//    (4,'someone@nowhere.com','sesam','customer');
    ...
    @Test
    public void testLogin01() throws TemporaryException {
        // Can we log in
    ...
    public void testLogin02() throws TemporaryException {
        // We should get an exception if we use the wrong password
        User user = UserMapper.login( "jens@somewhere.com", "larsen" );
    }

    @Test
    public void testLogin03() throws TemporaryException {
    ...
    @Test
    public void testCreateUser01() throws TemporaryException {
